        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <Card className="w-full max-w-5xl mx-auto bg-white/95 backdrop-blur-sm">
            <CardHeader className="pb-8">
              <CardTitle className="text-center text-3xl md:text-4xl font-bold text-gray-800 mb-4">
                Rentas Vitalicias
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-8 px-8 md:px-12">
              ...
              <section>
                <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">¿Qué es una Renta Vitalicia?</h2>
              ...
              {/* Ventajas */}
              <section>
                <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">Ventajas de las Rentas Vitalicias</h2>
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    <CheckCircle className="h-6 w-6 text-green-600 mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="text-xl font-semibold text-gray-800 mb-2">Es fija.</h3>
                  ...
                  <div className="flex items-start space-x-4">
                    <CheckCircle className="h-6 w-6 text-green-600 mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="text-xl font-semibold text-gray-800 mb-2">Te protege contra la inflación.</h3>
                      <p className="text-lg text-gray-600 leading-relaxed">
                  ...
                  <div className="flex items-start space-x-4">
                    <CheckCircle className="h-6 w-6 text-green-600 mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="text-xl font-semibold text-gray-800 mb-2">Es de por vida.</h3>
                      <p className="text-lg text-gray-600 leading-relaxed">
                  ...
                  <div className="flex items-start space-x-4">
                    <CheckCircle className="h-6 w-6 text-green-600 mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="text-xl font-semibold text-gray-800 mb-2">Es personalizable.</h3>
                      <p className="text-lg text-gray-600 leading-relaxed">
              ...
              <section>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    <div className="bg-orange-500 text-white rounded-full w-10 h-10 flex items-center justify-center text-lg font-bold flex-shrink-0">
                      1
                    </div>
                    <div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <div className="flex flex-col sm:flex-row gap-4">
                        <a
                          href="https://calendly.com/pensionfi/evaluacion"
                          target="_blank"
                          rel="noopener noreferrer"
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-gray-800 mb-2">Seguimiento.</h3>
                      <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-gray-800 mb-2">¡Ahora a jubilar!</h3>
                      <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
              ...
              <section>
                ...
                <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                  <ul className="space-y-3 text-lg md:text-xl text-gray-700 leading-relaxed">
