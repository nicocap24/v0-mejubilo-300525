              ...
              <div className="flex flex-col items-center gap-4 pt-4">
                ...
                <div className="flex flex-col items-center gap-3 pt-4 border-t border-gray-200 w-full">
                  ...
                  <div className="flex items-center gap-4">
                    {/* WhatsApp Share */}
                    <a
                      href={`https://wa.me/?text=${encodeURIComponent("Yo ya descubrí mi pensión y tu pensión ? 😱. https://mejubilo.com")}`}
                      target="_blank"
                    ...
                    {/* X (Twitter) Share */}
                    <a
                      href={`https://twitter.com/intent/tweet?text=${encodeURIComponent("Yo ya descubrí mi pensión y tu pensión ? 😱. https://mejubilo.com")}`}
                      target="_blank"
                      rel="noopener noreferrer"
                    ...
                    {/* Gmail Share */}
                    <a
                      href={`mailto:?subject=${encodeURIComponent("Descubre tu pensión")}&body=${encodeURIComponent("Yo ya descubrí mi pensión y tu pensión ? 😱. https://mejubilo.com")}`}
