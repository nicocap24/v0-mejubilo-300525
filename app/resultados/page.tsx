...
export default function ResultsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-green-50 to-yellow-50 py-12">
      <div className="container mx-auto px-4">
        <Link href="/evaluar" className="inline-flex items-center text-gray-600 hover:text-gray-900 mb-6">
          <ArrowLeft className="h-4 w-4 mr-2" />
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex justify-center">
              <Button
                ...
                disabled={isSaving || dataSaved}
                className={`flex items-center gap-2 ${dataSaved ? "bg-green-500 hover:bg-green-600" : "bg-blue-500 hover:bg-blue-600"} text-white`}
              >
                {dataSaved ? (
                  <>
            ...
            <div className="flex gap-3 pt-4">
              <Link href="/evaluar" className="flex-1">
                <Button variant="outline" className="w-full">
                  Recalcular
                </Button>
              </Link>
              <Link href="/" className="flex-1">
                <Button className="w-full bg-orange-500 hover:bg-orange-600 text-white">Contactar Asesor</Button>
              </Link>
            </div>
